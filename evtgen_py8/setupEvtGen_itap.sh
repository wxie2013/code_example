...
then
    ...
    $CMAKE -DHEPMC3_ENABLE_ROOTIO:BOOL=ON -DHEPMC3_ENABLE_PYTHON:BOOL=OFF -DCMAKE_INSTALL_PREFIX:PATH=$INSTALL_PREFIX $BUILD_BASE/sources/$HEPMC3PKG -DCMAKE_CXX_STANDARD=17
    make
    make install
...
cd $INSTALL_PREFIX
ln -s $INSTALL_PREFIX/lib64/* $INSTALL_PREFIX/lib/
