...
then
    ...
    $CMAKE -DCMAKE_C_COMPILER=gcc -DCMAKE_CXX_COMPILER=g++ -DCMAKE_INSTALL_PREFIX:PATH=$INSTALL_PREFIX $BUILD_BASE/sources/$HEPMC2PKG -Dmomentum:STRING=GEV -Dlength:STRING=MM
    make
    make install
    ...
    $CMAKE -DCMAKE_C_COMPILER=gcc -DCMAKE_CXX_COMPILER=g++ -DHEPMC3_ENABLE_ROOTIO:BOOL=ON -DHEPMC3_ENABLE_PYTHON:BOOL=ON -DCMAKE_INSTALL_PREFIX:PATH=$INSTALL_PREFIX $BUILD_BASE/sources/$HEPMC3PKG -DCMAKE_CXX_STANDARD=17
    make
    make install
...
then
    ...
    then
        $CMAKE -DCMAKE_C_COMPILER=gcc -DCMAKE_CXX_COMPILER=g++ \
          -DCMAKE_INSTALL_PREFIX:PATH=$INSTALL_PREFIX $BUILD_BASE/sources/evtgen \
		...
		-DEVTGEN_BUILD_TESTS=ON -DEVTGEN_BUILD_VALIDATIONS=ON \
		-D CMAKE_PREFIX_PATH=$ROOTSYS -D CMAKE_CXX_STANDARD=17
    else
        $CMAKE -DCMAKE_C_COMPILER=gcc -DCMAKE_CXX_COMPILER=g++ \
          -DCMAKE_INSTALL_PREFIX:PATH=$INSTALL_PREFIX $BUILD_BASE/sources/evtgen \
