...
{//.. use recusion. 
 //using reference to a  pointer to keep the changes occurs in the function outside the function when function call is finished
 //advantage over pointer to pointer is to avoid writing * all the time
